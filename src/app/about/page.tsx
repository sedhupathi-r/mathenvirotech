            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="max-w-full">
                <div className="mb-6">
                  ...
                  <p className="text-sm font-medium leading-relaxed text-body-color sm:text-base sm:leading-relaxed">
                ...
                <Link
                  href="/images/MSME An.pdf"
                  target="_blank"
                  className="inline-block rounded-lg bg-black p-2 px-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-black/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5"
                >
                  View Certificates
                </Link>
              </div>
