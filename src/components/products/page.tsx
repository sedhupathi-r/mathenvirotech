...
const productsData: any = [
  {
    ...
    title: "Less Area Requirement",
    paragraph:
      "MBR - ETP are Membrane Bio Reactor based Effluent treatment and recycling plants.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "The Effluent Treatment System being proposed by us is MBBR Based technology.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Increasing the Air Quantity",
    paragraph: "Minimal moving parts thus lesser maintenance requirements.",
  },
];
    ...
    <>
      <section id="products" className="py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="Our Products"
            paragraph="Solution equipments for your waste water."
            center
          />

          <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-2 lg:grid-cols-3">
            {productsData.map((feature) => (
              <div className="w-full" key={feature.key}>
